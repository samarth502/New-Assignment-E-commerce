  ...
  return (
    <nav className=" shadow-lg bg-yellow-300  ">
      <div className=" max-sm:w-full">
        <div className="flex md:justify-center md:pt-8 md:items-center  clipPathOne  sm:h-28 xs:h-24  bg-black lg:mt-[-50px] sm:px-5 xs:px-5 md:mt-[-50px] xs:justify-between xs:items-center sm:justify-between sm:items-center sm:mt-[-40px] xs:mt-5 xs:w-full max-xs:justify-between max-xs:items-center">
